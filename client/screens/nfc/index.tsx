...
export default function NFCScreen() {
  ...
  const handleStartScan = useCallback(async () => {
    if (Platform.OS === 'web') {
      Alert.alert('提示', 'Web 平台暂不支持 NFC 功能');
      return;
    }
  ...
  return (
    <Screen safeAreaEdges={['top']} style={styles.screen}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>NFC 触碰</Text>
      ...
      >
        ...
        <Animated.View entering={FadeInUp.delay(200)} style={styles.section}>
          <Text style={styles.sectionTitle}>家庭 NFC 标签</Text>
        ...
        <Animated.View entering={FadeInUp.delay(400)} style={styles.section}>
          <Text style={styles.sectionTitle}>最近触碰</Text>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text style={styles.readButtonText}>读取已有回忆</Text>
            </TouchableOpacity>
          </Animated.View>
        </TouchableOpacity>
      )}
